...
SECRET_KEY = 'django-insecure-5ja#*xbz9bp+7$zh&2j=s1stycj(jre(rwvru18+2z(b38e6v4'
...
ASGI_APPLICATION = "shop_management.asgi.application"

# Set up the channel layer using Redis
CHANNEL_LAYERS = {
    "default": {
